...
function closePopup() {
    ...
    clearTimeout(timer); // Clear the timer if the user closes it manually
    timer = setTimeout(showPopup, 30000); // Restart timer after close
}

timer = setTimeout(showPopup, 30000); // Set the timer for 10 seconds (10000 milliseconds)
...
document
    ...
    .addEventListener("submit", function(event) {
        ...
        messageDiv.querySelector(".success-icon").style.display = "none";
        messageDiv.querySelector(".fail-icon").style.display = "none";
        ...
        let animationInterval = setInterval(() => {
            ...
            submitButton.textContent = "Sending" + dots;
        }, 500);
        ...
        fetch(form.action, {
            ...
            .then((data) => {
                ...
                if (data.includes("Success")) {
                    ...
                    //   messageDiv.querySelector(".success-icon").style.display = "block";
                    ...
                    messageTextSpan.textContent = data;
                }
            })
            .catch((error) => {
                clearInterval(animationInterval);
                ...
                submitButton.disabled = false;
                messageDiv.querySelector(".fail-icon").style.display = "block";
...
//    jQuery("#send_message").on("click", function (event) {
//      event.preventDefault();

//      var name = jQuery(".contact_form #name").val();
//      var email = jQuery(".contact_form #email").val();
//      var message = jQuery(".contact_form #message").val();
//      var subject = jQuery(".contact_form #subject").val(); // Get the subject

//      var messageDiv = jQuery(".contact_form .returnmessage");
//      var successMessage = messageDiv.data("success");

//      messageDiv.empty();
//      jQuery("div.empty_notice").hide();
...
//      jQuery.ajax({
//        type: "POST",
//        url: "process_form.php", // Your PHP script
//        data: {
//          ajax_name: name, // Use the correct data names
//          ajax_email: email,
//          ajax_message: message,
//          ajax_subject: subject, // Send the subject
//        },
...
//            );
//            messageDiv.slideDown(500).delay(4000).slideUp(500);
//            jQuery("#contact_form")[0].reset();
//          } else {
//            messageDiv.append("<span class='contact_error'>" + data + "</span>");
//            messageDiv.slideDown(500).delay(2000).slideUp(500);
//          }
//        },
//        error: function (jqXHR, textStatus, errorThrown) {
//          messageDiv.append(
//            "<span class='contact_error'>An error occurred. Please try again later.</span>"
//          );
//          messageDiv.slideDown(500).delay(2000).slideUp(500);
